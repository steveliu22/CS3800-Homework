...
To generate $aababaaab$: A $\rightarrow$ AA $\rightarrow$ (aAaAb)(A) $\rightarrow$ (aAaAb)(AA) $\rightarrow$ (aAaAb)(aAbAa)(A) $\rightarrow$ (aAaAb)(aAbAa)(AA) $\rightarrow$ (aAaAb)(aAbAa)(aAaAb)(A) $\rightarrow$ (going to skip a few steps and replace all of the A's with the empty string) $\rightarrow$
aababaaab

To generate $aaaabb$: A $\rightarrow$ aAaAb $\rightarrow$ aAa(aAaAb)b $\rightarrow$ (skipping a few steps, replacing all of the A's with the empty string)
$\rightarrow$ aaaabb
...
However, since we know that $k > 0$, this means that $2Pk + k^2 + k > P$ which violates the condition that $|vxy| \leq P$.
