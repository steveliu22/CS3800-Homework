...
Let's assume that there are $k$ number of a's in $vy$ then the number of b's is $|vy| - k$. Since $|a| = \sqrt{|b|}$ in the original $S$, the new number of a's after pumping $i = 2$ times is $\sqrt{|b|} + 2k$ and the new number of b's is $|b| + 2(|vy| - k)$. If we square the new number of a's, $(\sqrt{|b|} + 2k)^2$, we get $|b| + 4k\sqrt{|b|} + 4k^2$. In order for the pumped string to be in $S$, the equation, 
$|b| + 4k\sqrt{|b|} + 4k^2$ = $|b| + 2(|vy| - k)$ has to be satisfied. Simplified: $2k\sqrt{|b|} + 2k^2$ = $|vy| - k$ 
