...
\noindent 0101 cannot be generated because the regular expression recognizes the language of all strings in which the first and last values are either both 0's or both 1's. Since 0101 has a 0 in the beginning and 1 in the end, this string is not in the regular expression. 
